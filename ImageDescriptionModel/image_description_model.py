...
class ImageDescriptionModel():
    ...
    def generate_prompt(self, dictionary):
        system_message = """
            ...
            An example of the response you should give: "The image shows a person holding a knife with a blade that has text engraved on it. The person is wearing a light-colored dress with lace details on the sleeves. Their hair is long and blonde."
        """
        human_messages = [
            {"type": "text", "text": dictionary["question"]},
            {"type": "image_url", "image_url": {"url" : dictionary['image_url']}}
        ]
    ...
    def get_image_description_and_object(self, image_path):
        ...
        answer = chain.invoke({"question": "What is depicted in this image?", "image_url": f"data:image/jpeg;base64, {base64_image}"})
        return  answer
